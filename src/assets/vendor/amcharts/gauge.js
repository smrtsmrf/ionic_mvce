  ...
  d.GaugeBand =
    d.Class({
      construct: function () {
        ...
        var e = c.chart, g = c.startAngle, l = c.radiusRealReal, n = c.singleValueAngle, h = e.container, k = c.minorTickLength, p = d.toCoordinate(this.radius, l);
...
(function () {
  ...
  d.AmAngularGauge = d.Class({
    inherits: d.AmChart, construct: function (a) {
      ...
      if (!a.hidden) {
        var e = a.axis, g = e.radiusReal, l = e.centerXReal, n = e.centerYReal, h = a.startWidth, k = a.endWidth, p =
        ...
        var e = Math.sin(b / 180 * Math.PI), g = Math.cos(b / 180 * Math.PI), m = Math.sin((b + 90) / 180 * Math.PI), z = Math.cos((b + 90) / 180 * Math.PI), c = d.polygon(c, [l - h / 2 *
